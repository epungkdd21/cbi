        ...
        <div>
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-4 max-w-xl text-sm leading-6 text-muted-foreground">Nikmati Dwipantara, kisah perjalanan lintas ruang dan waktu. Pilih jadwal dan isi data pemesan untuk mendapatkan tiket digital.</p>
            </div>
